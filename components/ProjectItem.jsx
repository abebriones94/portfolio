...
const ProjectItem = ({ title, backgroundImg, projectUrl, builtWith }) => {
  return (
    <div className="relative flex items-center justify-center h-auto w-full shadow-xl shadow-gray-500 rounded-xl p-4 group hover:bg-gradient-to-r from-[#4fbeea] to-[#38ffe4]">
      <Image
